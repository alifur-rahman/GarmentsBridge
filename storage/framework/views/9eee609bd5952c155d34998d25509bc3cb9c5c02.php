...
<head>
    ...
    <!-- Title -->
    <title><?php echo e(\App\CPU\translate('Dealer | login')); ?></title>
                        ...
                        <form id="form-id"  action="<?php echo e(route('seller.auth.login')); ?>" method="post">
                            ...
                            <div class="text-center">
                                <div class="mb-5">
                                    ...
                                    <center><h1 class="h4 text-gray-900 mb-4"><?php echo e(\App\CPU\translate('welcome_back_to_dealer_login')); ?></h1>
                                    </center>
                                </div>
...
<?php /**PATH E:\XAMMP\htdocs\garments-bridge\resources\views/seller-views/auth/login.blade.php ENDPATH**/ ?>