<?php $__env->startSection('title', \App\CPU\translate('Retailer | Register')); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card border-0 box-shadow">
                    <div class="card-body">
                        <h2 class="h4 mb-1 text-center"><?php echo e(\App\CPU\translate('no_account')); ?></h2>
                        <p class="font-size-sm text-muted mb-4 text-center"><?php echo e(\App\CPU\translate('Register as a new retailer')); ?>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\XAMMP\htdocs\garments-bridge\resources\views/customer-view/auth/register.blade.php ENDPATH**/ ?>