<?php $__env->startSection('title', \App\CPU\translate('Retailer | Login')); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card border-0 box-shadow">
                    <div class="card-body">
                        <h2 class="h4 mb-1 text-center"><?php echo e(\App\CPU\translate('sing_in')); ?></h2>
                        <h5 class="h6 text-gray-900 mb-4 text-center"><?php echo e(\App\CPU\translate('welcome_back_to_retailer_login')); ?></h5>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\XAMMP\htdocs\garments-bridge\resources\views/customer-view/auth/login.blade.php ENDPATH**/ ?>