...
@section('title', \App\CPU\translate('Retailer | Register'))
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card border-0 box-shadow">
                    <div class="card-body">
                        <h2 class="h4 mb-1 text-center">{{\App\CPU\translate('no_account')}}</h2>
                        <p class="font-size-sm text-muted mb-4 text-center">{{\App\CPU\translate('Register as a new retailer')}}
                            .</p>
